...
-- Tiempo de generación: 02-07-2018 a las 18:31:17
...
(1, 1, NULL, '17501001169098', 'Shampoo 2en1 C. Clásico', 'Pantene', 3, 'BX', '200.0000', 'ml', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(3, 1, NULL, '7501001169091', 'Shampoo Rizos Definidos', 'Pantene', 3, 'BX', '200.0000', 'ml', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(4, 1, NULL, '7506339355123', 'Acondicionador Summer', 'Pantene', 3, 'BX', '200.0000', 'ml', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(5, 1, NULL, '7501001171780', 'Acondicionador Liso Extremo', 'Pantene', 3, 'SH', '10.0000', 'ml', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(7, 1, NULL, '17791290011561', 'Matic Detergente Líquido 1er lavado', 'Nevex', 4, 'BX', '3.0000', 'l', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(8, 1, NULL, '17791290011554', 'Matic Detergente Líquido 1er lavado', 'Nevex', 4, 'CBL', '3.0000', 'l', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0),
(9, 1, NULL, '75010011690934', 'Shampoo Rizos Definidos', 'Pantene', 3, 'BX', '200.0000', 'ml', 'MX', NULL, NULL, NULL, NULL, NULL, '2018-07-02 00:00:00', '2018-07-02 00:00:00', 0);
...
INSERT INTO `productos_empaques` (`id`,`producto`, `empaque`) VALUES
(1, 1, 1),
(2, 3, 1),
(3, 7, 1),
(4, 4, 2),
...
ALTER TABLE `grupos_empresas`
	ADD PRIMARY KEY (`id`),
  	ADD KEY `grupos_empresas empresas_idx` (`empresa_id`);
...
--
ALTER TABLE `grupos_empresas`
  ADD CONSTRAINT `grupos_empresas empresas` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `grupos_empresas grupos` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
